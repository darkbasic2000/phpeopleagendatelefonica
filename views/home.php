        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark bg-success fw-bold text-light">
                <div class="container-fluid">
                    <a class="navbar-brand" href="<?= BASE ?>"><i class="bi bi-filetype-php" style="font-size: 2rem;">PHPeople</i></a>
                    ...
                    <table class="table table-sm table-success table-striped">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?php elseif($contatos != null && count($contatos) > 0): ?>
                                    <div class="alert alert-primary" role="alert">
                                        <i class="bi bi-info-circle-fill"></i> <?= count($contatos)?> registro(s) encontrado(s)
                                    </div>
                                <?php else: ?>
